...
namespace MegaDeskWeb.Models
{
    ...
    {        
        public static void Initialize(MegaDeskWebContext context)
        {
            ...
            {
                new RushShipping{RushShippingName="Three-Day Large",RushShippingPrice=80},
                new RushShipping{RushShippingName="Three-Day Medium",RushShippingPrice=70},
                new RushShipping{RushShippingName="Three-Day Small",RushShippingPrice=60},
                new RushShipping{RushShippingName="Five-Day Large",RushShippingPrice=60},
                new RushShipping{RushShippingName="Five-Day Medium",RushShippingPrice=50},
